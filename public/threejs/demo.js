...
function init_threeScene(spec) {
    ...
    smallSpiderLoader.load(
        '/threejs/models/small_spider/small_spider.json',
        (geometry) => {
            const material = new THREE.MeshBasicMaterial({
                map: new THREE.TextureLoader().load('/threejs/models/small_spider/diffuse_spider.jpg'),
                morphTargets: true
            });
    ...
    bigSpiderLoader.load(
        '/threejs/models/big_spider/big_spider.json',
        (geometry) => {
            const material = new THREE.MeshBasicMaterial({
                map: new THREE.TextureLoader().load('/threejs/models/big_spider/diffuse_spider.jpg'),
                morphTargets: true
            });
    ...
    faceLoader.load(
        '/threejs/models/face/face.json',
        (geometry) => {
            const material = new THREE.MeshBasicMaterial({
                map: new THREE.TextureLoader().load('/threejs/models/face/diffuse_makeup.png'),
                // transparent: true
            });
    ...
    const calqueMesh = new THREE.Mesh(threeStuffs.videoMesh.geometry,  create_mat2d(new THREE.TextureLoader().load('/threejs/images/cadre_halloween.png'), true))
...
function init_faceFilter(videoSettings){
    JEEFACEFILTERAPI.init({
        canvasId: 'jeeFaceFilterCanvas',
        NNCpath: '/threejs/dist/', // root of NNC.json file
